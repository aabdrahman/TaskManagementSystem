...
{
    /// <inheritdoc />
    public partial class AddProc_GetUnitUserAnalytics : Migration
    {
        /// <inheritdoc />
            ...
            migrationBuilder.Sql(@"
					...
					BEGIN
							...
							SELECT [tu].[UserId], [u].[FirstName], [u].[LastName],
								...
								CAST(100.0 * (SUM(CASE WHEN [tu].[CompletionDate] IS NOT NULL THEN 1 ELSE 0 END) / NULLIF(COUNT(*), 0)) AS decimal(5, 2)) AS [CompletionRate],
