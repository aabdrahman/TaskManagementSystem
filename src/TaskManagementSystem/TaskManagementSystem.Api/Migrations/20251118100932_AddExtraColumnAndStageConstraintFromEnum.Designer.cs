...
namespace TaskManagementSystem.Api.Migrations
{
    ...
    [Migration("20251118100932_AddExtraColumnAndStageConstraintFromEnum")]
    partial class AddExtraColumnAndStageConstraintFromEnum
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("CreatedTasks", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_Stage", "[TaskStage] IN ('Development', 'Testing', 'Deployment', 'ChangeManagement', 'Completed')");
                        });
                });
